...
sequenceDiagram
    ...
    ユーザー->>クライアント: 「1️⃣ 作成」or「2️⃣ 参加」を選択
    ...
    alt 1️⃣ ルームを作成
        ...
        %% ← この Note により余白だけ確保（テキストは空白1つ）
        Note over ユーザー,クライアント:  
    ...
    loop 🔁 チャット中
        ユーザー->>クライアント: ✉️ メッセージを送信
        クライアント-->>ユーザー: 📨 他ユーザーのメッセージを受信
    end
