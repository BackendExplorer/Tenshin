...
sequenceDiagram
    ...
    %% === 🚀 起動フェーズ ===
    👤 ユーザー->>🖥️ Pythonクライアント: アプリ起動
    👤 ユーザー->>🖥️ Pythonクライアント: ユーザー名を入力
    👤 ユーザー->>🖥️ Pythonクライアント: 「1️⃣ 作成」or「2️⃣ 参加」を選択

    %% === 🏠 ルーム選択フェーズ ===
    alt 🆕 ルームを作成
        👤 ユーザー->>🖥️ Pythonクライアント: ルーム名を入力
        🖥️ Pythonクライアント-->>👤 ユーザー: 🔑 トークン発行（作成完了）
    else 🏃‍♂️ ルームに参加
        🖥️ Pythonクライアント-->>👤 ユーザー: 📜 ルーム一覧を表示
        👤 ユーザー->>🖥️ Pythonクライアント: 参加するルームを選択
        🖥️ Pythonクライアント-->>👤 ユーザー: 🔑 トークン発行（参加完了）
    end

    %% === 💬 チャットフェーズ ===
    👤 ユーザー->>🖥️ Pythonクライアント: チャットを開始

    loop 🔁 チャット中
        👤 ユーザー->>🖥️ Pythonクライアント: ✉️ メッセージを送信
        🖥️ Pythonクライアント-->>👤 ユーザー: 📨 他ユーザーのメッセージを受信
    end
